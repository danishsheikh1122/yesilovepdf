...
export default function AddPageNumbersComponent({
  ...
  const handleProcess = async () => {
    try {
      ...
      // Track the add page numbers action
      await pdfTrackers.addPageNumbers(files[0]);
    } catch (error) {
                    ...
                    <div className="space-y-4 text-xs leading-relaxed">
                      <div>
                        ...
                        <p className="text-gray-700">
                          This is a sample document that demonstrates how page
                          numbers will appear when added to your PDF. Upload a
                          PDF to see the actual first page preview.
                        </p>
                      </div>
                    ...
                    {previewLoading ? (
                      ...
                      <div className="relative bg-white border rounded-lg overflow-hidden">
                        ...
                        <div className="absolute top-2 left-2 text-xs text-gray-500 bg-white bg-opacity-90 px-2 py-1 rounded shadow max-w-xs break-words">
                          <span className="break-all">{files[0].name}</span> •
                          First Page Preview
                        </div>
                      </div>
                    ) : (
                        ...
                        <div className="space-y-4 text-xs">
                          <div className="bg-blue-50 p-3 rounded-lg">
                            ...
                            <p className="text-blue-700">
                              Page numbers will be added to your PDF document in
                ...
                <div className="grid grid-cols-3 gap-2">
                  {positions.map((pos) => (
                    <Button
                      key={pos.value}
                      variant={
                        options.position === pos.value ? "default" : "outline"
                      }
                      size="sm"
                      onClick={() =>
                        setOptions({ ...options, position: pos.value })
                      }
                      className={cn(
                    ...
                    >
                      ...
                      <span className="text-xs font-medium text-center whitespace-normal break-words">
                        {pos.label}
                      </span>
                    </Button>
                  ))}
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setOptions({ ...options, startPage: parseInt(value) })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
