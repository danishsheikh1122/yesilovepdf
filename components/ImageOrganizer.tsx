...
export default function ImageOrganizer({
  ...
  const handleAddMoreImages = (newFiles: FileList | null) => {
    ...
    if (imageFiles.length > 0) {
      ...
      // Update parent component with new file list
      const allFiles = [
        ...organizedImages.map((img) => img.file),
        ...imageFiles,
      ];
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-sm text-gray-600">
              {organizedImages.length} image
              {organizedImages.length !== 1 ? "s" : ""}
            </div>
          </div>

          <div className="text-sm text-gray-600 mb-4">
            Drag images to reorder • Click rotate to turn images • Remove
            unwanted images
          </div>
        ...
        {organizedImages.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Add images to start organizing
            </p>
          </div>
        )}
      </CardContent>
