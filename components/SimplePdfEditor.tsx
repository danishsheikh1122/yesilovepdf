...
import { Upload, Type, Square, Circle, Minus, Pen, Undo, Redo, ZoomIn, ZoomOut, Download, Trash2 } from 'lucide-react';
...
export default function SimplePdfEditor() {
  ...
  const addElementToHistory = useCallback((newElements: DrawingElement[]) => {
